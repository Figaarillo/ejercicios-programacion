1. Ingresar una cadena de caracteres que termine en un punto e indicar la cantidad  de  caracteres  que  posee.  Mostrando  la  misma  en  formato mayúscula a la salida del programa.
